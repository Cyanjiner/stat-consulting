...
#Multiple Regression 
my.lm1 <- lm(IncidentScore~CriminalHistory+AlcoholDrugProblems+SuicideRisk_Total+HomicideRisk_Total+TraumaHistory+AodInvolvement+Disruption+GlobalAodPsychosocialDistruptionAndProblems, data= ClientAllData)
summary(my.lm1)

my.lm2 <- lm(IncidentScore~CriminalHistory+AlcoholDrugProblems+SuicideRisk_Total+HomicideRisk_Total+TraumaHistory+AodInvolvement+Disruption+GlobalAodPsychosocialDistruptionAndProblems+CurrentAge+as.factor(MaritalStatus)+as.factor(Race), data= ClientAllData)
summary(my.lm2)

my.lm3 <- lm(LegalNonConformingLastSixMonths~CriminalHistory+AlcoholDrugProblems+SuicideRisk_Total+HomicideRisk_Total+TraumaHistory+AodInvolvement+Disruption+GlobalAodPsychosocialDistruptionAndProblems, data= ClientAllData)
summary(my.lm3)

my.lm4 <- lm(LegalNonConformingLastSixMonths~CriminalHistory+AlcoholDrugProblems+SuicideRisk_Total+HomicideRisk_Total+TraumaHistory+AodInvolvement+Disruption+GlobalAodPsychosocialDistruptionAndProblems+CurrentAge+as.factor(MaritalStatus)+as.factor(Race), data= ClientAllData)
summary(my.lm4)
